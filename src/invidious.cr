...
# mooleshacat (begin)
REDIS_CLI = Process.find_executable("redis-cli").as(String)
NODE = Process.find_executable("node").as(String)
TIMEOUT = Process.find_executable("timeout").as(String)
CPULIMIT = Process.find_executable("cpulimit").as(String)
# mooleshacat (end)
